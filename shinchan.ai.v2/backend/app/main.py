"""
Shinchan AI - FastAPI Application
...
async def startup_event():
    logger.info("🚀 Shinchan AI API starting up...")
...
async def shutdown_event():
    logger.info("👋 Shinchan AI API shutting down...")


@app.get("/")
async def root():
    return {
        "message": "Shinchan AI API",
        "version": "1.0.0",
        "docs": "/docs",
    }
